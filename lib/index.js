 ...
 */
exports.plugin.pkg = pkg; // hapi requires attributes for a plugin. also see: http://hapijs.com/tutorials/plugins
...
internals.implementation = function (server, options) {
  ...
  const raiseError = function (errorType, message, scheme, attributes) {
