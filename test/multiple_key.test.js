...
test('Access restricted content with multiple valid tokens for a valid tenant', async (t) => {
...
test('Access restricted content with an invalid token and tenant', async (t) => {
  // use the token as the 'authorization' header in requests
...
test('Access restricted content with a valid token and tenant but user is not allowed', async (t) => {
  // use the token as the 'authorization' header in requests
...
test('Access restricted content without tenant specified in token', async (t) => {
  // use the token as the 'authorization' header in requests
...
test('Access restricted content with non-existent tenant specified', async (t) => {
  // use the token as the 'authorization' header in requests
