...
test('Attempt to access restricted content using inVALID Cookie Token', async (t) => {
...
test('Attempt to access restricted content with VALID Token but malformed Cookie', async (t) => {
...
test('Access restricted content with VALID Token Cookie', async (t) => {
...
test('Access restricted content with VALID Token Cookie (With Options!)', async (t) => {
...
test('Authorization Header should take precedence over any cookie', async (t) => {
...
test('Valid Google Analytics cookie should be ignored', async (t) => {
...
test('Valid Google Analytics cookie should be ignored (BAD Header Token)', async (t) => {
...
test('Attempt to access restricted content with cookieKey=false', async (t) => {
...
test('Attempt to access restricted content with cookieKey=\'\'', async (t) => {
