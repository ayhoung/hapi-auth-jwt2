...
test('Access restricted content using scopes (with VALID Token and VALID scope)', async (t) => {
...
test('Access restricted content using scopes (with VALID Token and INVALID scope)', async (t) => {
  // use the token as the 'authorization' header in requests
