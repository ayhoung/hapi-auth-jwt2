...
test('Access a route that has no auth strategy', async (t) => {
...
test('customVerify simulate error condition', async (t) => {
...
test('customVerify simulate error condition but is safely not customised', async (t) => {
...
test('customVerify with fail condition', async (t) => {
...
test('Custom Verification in \'try\' mode ', async (t) => {
...
test('Custom Verification in \'optional\' mode ', async (t) => {
...
test('Custom Verification in \'required\' mode ', async (t) => {
