...
test('Auth mode \'try\' should not set isAuthenticated to true when no token sent', async (t) => {
...
test('Auth mode \'optional\' should not set isAuthenticated to true when no token sent', async (t) => {
